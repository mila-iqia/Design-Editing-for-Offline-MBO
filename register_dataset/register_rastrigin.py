...
class RastriginDataset(ContinuousDataset):

    def __init__(self, **kwargs):
        # define a set of inputs and outputs of a quadratic function
        obj_fun = Rastrigin(dim_problem=60)  # dimension of x
        ...
        super(RastriginDataset, self).__init__(x, y, **kwargs)


class RastriginOracle(ExactOracle):
    ...
    def __init__(self, dataset: ContinuousDataset, **kwargs):
        ...
        super(RastriginOracle, self).__init__(
...
if __name__ == '__main__':
    ...
    task = design_bench.make("Rastrigin-Exact-v0")
